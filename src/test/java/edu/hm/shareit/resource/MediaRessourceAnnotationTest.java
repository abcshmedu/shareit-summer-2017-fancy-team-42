 ...
 *
 */
public class RessourceAnnotationTest {

	public static final String APP_URL = "/";
    public static final int PORT = 8082;
    public static final String WEBAPP_DIR = "./src/main/webapp/";
	
	private String uri_base= "http://localhost:8082/shareit/media";
	...
	public void testGetBooks() throws Exception {
		connection = (HttpURLConnection) new URL(uri_base+"/books").openConnection();
	...
	public void testGetDiscs() throws Exception {
		connection = (HttpURLConnection) new URL(uri_base+"/discs").openConnection();
		connection.setRequestMethod("GET");
		connection.connect();
		int code = connection.getResponseCode();
		connection.disconnect();
	...
	public void testGetBookISBN() throws Exception {
		connection = (HttpURLConnection) new URL(uri_base+"/books/1").openConnection();
		connection.setRequestMethod("GET");
		connection.connect();
		int code = connection.getResponseCode();
		connection.disconnect();
	...
	public void testGetDiscCode() throws Exception {
		connection = (HttpURLConnection) new URL(uri_base+"/discs/1").openConnection();
		connection.setRequestMethod("GET");
		connection.connect();
		int code = connection.getResponseCode();
		connection.disconnect();
